...
number_epochs = 30
solver = Solver(model,data_dict,optim_config={'learning_rate':1e-4},lr_decay =0.99,num_epochs=number_epochs,batch_size=200,print_every=5000,num_train_samples=40000)
solver.train()
