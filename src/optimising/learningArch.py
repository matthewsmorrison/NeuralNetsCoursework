...
for arch in archs:
    model = FullyConnectedNet(arch,input_dim = 48*48*1, dropout=0, reg=0.25, dtype=np.float64, seed=237)
    number_epochs = 5
    solver = Solver(model,data_dict,optim_config={'learning_rate':8e-5},lr_decay=0.985,num_epochs=number_epochs,batch_size=200,print_every=5000,num_train_samples=40000)
